...
int post_process_yolov11(int8_t *input, int model_in_h, int model_in_w,
                         ...
                         detect_result_group_t *group)
{
    ...
    // YOLOv11 output: [1, 84, 8400] -> 84 = 4 bbox + 80 classes
...
// For YOLOv11 with multiple outputs (split heads)
int post_process_yolov11_multi(int8_t **inputs, int num_outputs,
                                ...
                                detect_result_group_t *group)
{
    ...
    // YOLOv11 split outputs: bbox (64ch), classes (80ch), objectness (1ch) for each scale
